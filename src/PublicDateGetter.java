...
public class PublicDateGetter {
	...
	String weathergetter1(String place) throws IOException {
		Cutter c = new Cutter();
		StringBuilder urlBuilder = new StringBuilder("http://www.kma.go.kr/weather/forecast/mid-term-rss3.jsp?stnId=108"); /*URL*/
	    String val;   
		
        //urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=LgRgbunXMOlZA23p%2B3W9rS6oLCPvoFIt%2FIFz1k4lLvYZPSmOjf6WgbER6%2Be2gybE73XKzeGgaaveKiSn1SlykA%3D%3D"); /*Service Key*/
        //urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("-", "UTF-8")); /*공공데이터포털에서 받은 인증키*/
        //urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
        //urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
        //urlBuilder.append("&" + URLEncoder.encode("dataType","UTF-8") + "=" + URLEncoder.encode("XML", "UTF-8")); /*요청자료형식(XML/JSON)Default: XML*/
        //urlBuilder.append("&" + URLEncoder.encode("base_date","UTF-8") + "=" + URLEncoder.encode("20200601", "UTF-8")); /*15년 12월 1일 발표*/
        //urlBuilder.append("&" + URLEncoder.encode("base_time","UTF-8") + "=" + URLEncoder.encode("0600", "UTF-8")); /*06시 발표(정시단위)*/
        urlBuilder.append("&" + URLEncoder.encode("nx","UTF-8") + "=" + URLEncoder.encode("27", "UTF-8")); /*예보지점의 X 좌표값*/
	...
	String weather() {
		try{
            //서울시청의 위도와 경도
            String lon = "127.004681";  //경도
            String lat = "37.276848";   //위도
